...
- (void)didLoadFromCCB {
    ...
    for (CCNode *bush in _bushes) {
        ...
        [_parallaxBackground addChild:bush z:1 parallaxRatio:_bushParallaxRatio positionOffset:offset];
    }
    
    for (CCNode *cloud in _clouds) {
        CGPoint offset = cloud.position;
        [self removeChild:cloud];
        [_parallaxBackground addChild:cloud z:1 parallaxRatio:_cloudParallaxRatio positionOffset:offset];
    }
